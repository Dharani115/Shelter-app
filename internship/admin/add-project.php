...
if(isset($_POST['submit']))
{
  ...
  // Check if file already exists
	...
	$query="INSERT into `project` (title,project_image, description, created_on,  modified_on)
	VALUES ('$title', '$project_image','$description','$created_on', '$modified_on')";
	$result = mysqli_query($con,$query);
           if($result){
            $msg= "Project Details added  successfully.";
     }
	 else{
		 $msg="Sorry, unable to add please try again.";
	 }
...
<div class="form-group">
	...
	<div class="form-group">
      ...
      <input type="file" class="form-control" id="project_image" placeholder="Enter project Image"  onchange="return fileValidation()" name="project_image" data-rule="required" data-msg="Please include project image">
    <div class="validation"></div>
	</div>	
	<div class="form-group">
      <label for="description">Description</label>
      <input type="text" class="form-control" id="description" placeholder="Enter sub title" name="description" data-rule="required" data-msg="This feild is required">
    <div class="validation"></div>
	</div>
