...
<html lang="en">
 ...
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css">
  ...
  <body>
	...
	<a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#"><img src="../image/logoo.jpg" alt="image not found" width="100px" height="50px"/></a>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
		  ...
		  <li class="nav-item">
            <a class="nav-link <?php if($active=='add-banner'){echo 'active';}else{echo'noactive';}?>" href="banner-at.php">
              <span data-feather="layers"></span>
              Banners
            </a>
          </li>
