...
<div class="form-group">
	...
	<div class="form-group">
      ...
      <input type="file" class="form-control" id="project_image" placeholder="Enter project Image"  onchange="return fileValidation()" name="project_image" data-rule="required" data-msg="Please include banner image">
    <div class="validation"></div>
	</div>	
