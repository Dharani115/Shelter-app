...
<body><!--footer section -->
	...
	<li class="list-inline-item"><a href="index 2.php">Home</a></li>
	<li class="list-inline-item"><a href="about.php">About</a></li>
	<li class="list-inline-item"><a href="project.php">Project</a></li>
	<li class="list-inline-item"><a href="service.php">Service</a></li>
	...
	<div class="footer-copyright text-center">
        ...
        <p>&copy; 2020 Copyright: MyWebsite.com</p>
	</div>
	<div>
  ...
  <div class="modal fade" id="myModal" role="dialog">
   ...
   <div class="validation"></div> </div>
    ...
    <input type="submit" id="insert" name="submit" class="btn btn-warning text-white" value="Submit"/>
  </form></div>
